...
### 🎨 Fitly Project Skills (Custom)
| Skill | Description |
|-------|-------------|
| `fitly-virtual-tryon` | AI try-on service, prompts, providers |
| `fitly-pwa-mobile` | PWA config, mobile-first patterns |
| `fitly-product-crawler` | URL parsing, image extraction |
...
|--------|-------|
| **Total Agents** | 16 |
| **Total Skills** | 43 (including 3 Fitly customs) |
| **Total Workflows** | 11 |
